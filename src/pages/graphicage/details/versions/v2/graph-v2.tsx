...
export const GraphicageV2: React.FC<GraphicageProps> = ({
  ...
  return (
    <div ref={containerRef} className="w-full overflow-x-auto border">
            ...
            >
              ...
              {battementEnd && (
                <line
                  ...
                  y1={yScale(stationMap[lastStop.stationId].distanceFromStart)}
                  y2={yScale(stationMap[lastStop.stationId].distanceFromStart)}
                  stroke={journey.color}
                  strokeWidth={3}
                  strokeDasharray="4 2"
                />
